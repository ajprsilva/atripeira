...
namespace atripeira.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
            ...
            this.Items.Add(new ItemViewModel() { LineOne = "História", LineTwo = "", LineThree = "" });
            this.Items.Add(new ItemViewModel() { LineOne = "Ingredientes", LineTwo = "", LineThree = "" });
            this.Items.Add(new ItemViewModel() { LineOne = "Receita", LineTwo = "", LineThree = "" });
